...
export default function ColeccionT2({ data }: Props) {
  const [activeCategory, setActiveCategory] = useState('Sillones');
  const sliderRef = useRef<HTMLDivElement>(null);

  const categories = ['Sillones', 'Sillas', 'Mesas', 'Deco'];

  const products = [
    { id: 1, title: 'Poltrona "Roma"', category: 'Sillones', imagePath: '/assets-t2/product-roma.webp', rating: 5 },
    { id: 2, title: 'Silla de Comedor "Oslo"', category: 'Sillas', imagePath: '/assets-t2/product-oslo.webp', rating: 5 },
    { id: 3, title: 'Silla de Cabecera "Milán"', category: 'Sillas', imagePath: '/assets-t2/product-milan.webp', rating: 5 },
    { id: 4, title: 'Poltrona "Tartán"', category: 'Sillones', imagePath: '/assets-t2/product-tartan.webp', rating: 5 },
  ];
