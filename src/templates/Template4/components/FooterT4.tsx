...
export default function FooterT4({ data }: Props) {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="w-full bg-gray-900 pt-12 lg:pt-16 pb-8 px-6 lg:px-8">
      <div className="max-w-[1280px] mx-auto flex flex-col">
        ...
        <ScrollReveal>
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-24">
            ...
            <div className="flex flex-col items-start w-full lg:max-w-[592px]">
              <a href="#inicio" className="text-white text-[24px] font-bold font-['Arimo'] tracking-wide uppercase mb-4">
                {data.businessName}
              </a>
              
              <p className="text-gray-400 text-[15px] lg:text-[16px] font-normal font-['Inter'] leading-relaxed mb-6">
                Especialistas en eliminación profesional de moho con más de 15 años de experiencia protegiendo hogares y negocios.
              </p>

              {/* Redes Sociales */}
              <div className="flex gap-4">
                {/* Facebook */}
                <a href={data.contact.facebook || '#'} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 rounded-[10px] flex justify-center items-center text-gray-300 hover:text-white hover:bg-[#059669] transition-all duration-300">
                ...
                {/* Instagram */}
                <a href={data.contact.instagram || '#'} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 rounded-[10px] flex justify-center items-center text-gray-300 hover:text-white hover:bg-[#059669] transition-all duration-300">
                ...
                {/* WhatsApp */}
                <a href={`https://wa.me/${data.contact.whatsapp}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-800 rounded-[10px] flex justify-center items-center text-gray-300 hover:text-white hover:bg-[#059669] transition-all duration-300">
        ...
        {/* =========================================
            COPYRIGHT
            ========================================= */}
        <div className="w-full mt-12 pt-8 border-t border-slate-800 flex justify-center text-center">
          <span className="text-gray-400 text-[13px] md:text-[14px] font-normal font-['Inter']">
