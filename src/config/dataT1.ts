...
export const configT1: ClientData = {
  ...
  menu: { 
    ...
    items: [
      ...
      // === TACOS (6 Ítems) ===
      { id: '13', title: 'Tacos al Pastor', description: 'Tres tacos de carne marinada, cebolla, cilantro fresco y un toque de lima.', price: '', category: 'Tacos', imagePath: '/assets-t1/menu-tacos.webp' },
      { id: '14', title: 'Combo Wrap', description: 'Wrap de carne asada con papas fritas y bebida a elección.', price: '', category: 'Tacos', imagePath: '/assets-t1/menu-wrap.webp' },
      { id: '15', title: 'Tacos con Queso Fundido', description: 'Tortillas rellenas de carne picada sazonada, lechuga fresca y abundante salsa de queso cheddar derretido.', price: '', category: 'Tacos', imagePath: '/assets-t1/tacos-queso-fundido.webp' },
      { id: '16', title: 'Tacos Dorados Crocantes', description: 'Tortillas de maíz crujientes rellenas de carne, lechuga, queso rallado y nuestra salsa especial de la casa.', price: '', category: 'Tacos', imagePath: '/assets-t1/tacos-dorados-crocantes.webp' },
      { id: '17', title: 'Tacos de Asada y Palta', description: 'Tradicionales tacos de carne asada servidos con cebolla, cilantro fresco y abundantes láminas de palta.', price: '', category: 'Tacos', imagePath: '/assets-t1/tacos-asada-palta.webp' },
      { id: '18', title: 'Tacos Estilo Callejero', description: 'Auténticos tacos mexicanos con carne fileteada, pico de gallo, cebolla morada y limas para acompañar.', price: '', category: 'Tacos', imagePath: '/assets-t1/tacos-estilo-callejero.webp' },

      // === OPCIONES VEGGIE (6 Ítems) ===
      { id: '19', title: 'Veggie Burger', description: 'Medallón de lentejas y quinoa, rúcula, tomate, cebolla morada y mayonesa vegana.', price: '', category: 'Opciones Veggie', imagePath: '/assets-t1/menu-burger-veggie.webp' },
      { id: '20', title: 'NotBurger Clásica', description: 'Medallón plant-based, queso vegetal derretido, tomate, cebolla morada y lechuga fresca.', price: '', category: 'Opciones Veggie', imagePath: '/assets-t1/notburger-clasica.webp' },
      { id: '21', title: 'Ciabatta Veggie', description: 'Pan ciabatta rústico relleno con queso, finas rodajas de tomate y hojas de lechuga.', price: '', category: 'Opciones Veggie', imagePath: '/assets-t1/ciabatta-veggie.webp' },
      { id: '22', title: 'Sándwich Integral Triple', description: 'Triple capa de pan integral tostado, lechuga crespa, tomate fresco y aros de cebolla morada.', price: '', category: 'Opciones Veggie', imagePath: '/assets-t1/sandwich-integral.webp' },
      { id: '23', title: 'Wrap de Soja y Vegetales', description: 'Tortillas rellenas de soja texturizada sazonada, lechuga fresca y vegetales asados.', price: '', category: 'Opciones Veggie', imagePath: '/assets-t1/wrap-soja-vegetales.webp' },
      { id: '24', title: 'Sándwich Baguette Fresco', description: 'Baguette crujiente y fresca con rodajas de vegetales de estación, queso y hojas verdes.', price: '', category: 'Opciones Veggie', imagePath: '/assets-t1/baguette-fresco.webp' },

      // === BEBIDAS (6 Ítems) ===
      { id: '25', title: 'Coca-Cola Regular', description: 'Lata de 354ml de la clásica gaseosa cola, bien helada para acompañar.', price: '', category: 'Bebidas', imagePath: '/assets-t1/lata-coca-cola.webp' },
      { id: '26', title: 'Pepsi Regular', description: 'Lata de 354ml, súper refrescante y con el sabor original de siempre.', price: '', category: 'Bebidas', imagePath: '/assets-t1/lata-pepsi.webp' },
      { id: '27', title: 'Fanta Naranja', description: 'Lata de 354ml de gaseosa sabor naranja, dulce, con gas y muy fría.', price: '', category: 'Bebidas', imagePath: '/assets-t1/lata-fanta.webp' },
      { id: '28', title: 'Sprite Sin Azúcar', description: 'Lata de 354ml, el mejor sabor lima-limón para refrescarte sin calorías.', price: '', category: 'Bebidas', imagePath: '/assets-t1/lata-sprite-zero.webp' },
      { id: '29', title: 'Cerveza Heineken', description: 'Lata de 473ml de cerveza premium lager, de sabor suave, rubia y ligera.', price: '', category: 'Bebidas', imagePath: '/assets-t1/lata-heineken.webp' },
      { id: '30', title: 'Agua Mineral Crystal', description: 'Botella de 500ml de agua purificada sin gas, ideal para tu comida.', price: '', category: 'Bebidas', imagePath: '/assets-t1/botella-agua-crystal.webp' }
    ] 
  },
